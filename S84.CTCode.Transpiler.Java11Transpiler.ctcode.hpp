#ifndef S84_CTCODE_TRANSPILER_JAVA11TRANSPILER_CTCODE_H
#define S84_CTCODE_TRANSPILER_JAVA11TRANSPILER_CTCODE_H
...
class Java11Transpiler;

class Java11Transpiler : public s84::ctcode::transpiler::standardstructure::ctcode::TargetSpecificFunctions {
public:
    Java11Transpiler();
    inline ~Java11Transpiler() {}
    ...
    std::string GetDefault(std::string java_type);
...
private:
    ...
    std::vector<std::string> class_definition;

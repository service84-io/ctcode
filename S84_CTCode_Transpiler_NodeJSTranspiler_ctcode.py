...
class NodeJSTranspiler(S84_CTCode_Transpiler_ctcode.Transpiler):
    ...
    def GetCallName(self: 'NodeJSTranspiler',name: 'S84_CTCode_dbnf_ctcode.Name') -> 'str':
        if name:
            return self.SnakeCaseToCamelCase(name.UnParse())
        else:
            return ""

    def GetVariableName(self: 'NodeJSTranspiler',name: 'S84_CTCode_dbnf_ctcode.Name') -> 'str':
        if name:
    ...
    def GetVariableChainNameTail(self: 'NodeJSTranspiler',tail: 'S84_CTCode_dbnf_ctcode.NameTail') -> 'str':
        accessor: 'str' = "."
        if tail:
    ...
    def GetVariableChain(self: 'NodeJSTranspiler',l_value: 'S84_CTCode_dbnf_ctcode.QualfiedName') -> 'str':
        if l_value:
    ...
    def GetTypeName(self: 'NodeJSTranspiler',name: 'S84_CTCode_dbnf_ctcode.Name') -> 'str':
        if name:
            return self.SnakeCaseToCamelCase(name.UnParse())
        else:
            return ""
    ...
    def GetQualifiedTypeName(self: 'NodeJSTranspiler',name_parts: 'list[S84_CTCode_dbnf_ctcode.Name]') -> 'str':
    ...
    def ProcessExdef(self: 'NodeJSTranspiler',exdef: 'str') -> 'None':
        Append(self.imports,Concat(Concat(Concat(Concat("import * as ",self.StripDot(exdef))," from \"./"),self.StripDot(exdef)),".js\""))
    ...
    def ProcessInterfaceFunctionDeclaration(self: 'NodeJSTranspiler',return_type: 'str',function_name: 'str',parameters: 'list[ParameterDeclaration]') -> 'None':
        Append(self.interface_definitions,Concat(Concat(Concat(self.Indentation(1),function_name),self.MakeParametersString(parameters))," {}"))
    ...
    def BeginProcessingClass(self: 'NodeJSTranspiler',class_name: 'str',implementing: 'str') -> 'None':
        ...
        ClearList(self.class_init)
        ClearList(self.class_functions)
        Append(self.class_init,Concat(self.Indentation(1),"constructor() {"))

    def BeginProcessingClassFunctionDefinition(self: 'NodeJSTranspiler',return_type: 'str',function_name: 'str',parameters: 'list[ParameterDeclaration]') -> 'None':
        Append(self.class_functions,"")
        Append(self.class_functions,Concat(Concat(self.Indentation(1),function_name),self.MakeParametersString(parameters)))
    ...
    def ProcessDeclaration(self: 'NodeJSTranspiler',indent: 'int',type: 'str',l_value: 'str',r_value: 'str') -> 'None':
        ...
        Append(self.class_functions,Concat(Concat(Concat(Concat(self.Indentation(indent),"var "),l_value)," = "),r_value))
    ...
    def FinishProcessingClassFunctionDefinition(self: 'NodeJSTranspiler',return_type: 'str',function_name: 'str',parameters: 'list[ParameterDeclaration]') -> 'None':
        noop: 'int' = 0

    def ProcessClassMemberDeclaration(self: 'NodeJSTranspiler',member_type: 'str',member_name: 'str') -> 'None':
        Append(self.class_init,Concat(Concat(Concat(Concat(self.Indentation(2),"this."),member_name)," = "),self.GetDefault(member_type)))
    ...
    def FinishProcessingCTCodeFile(self: 'NodeJSTranspiler') -> 'None':
        destination_file_name: 'str' = Concat(self.StripDot(self.base_name),".js")
    ...
    def BeginsWith(self: 'NodeJSTranspiler',prefix: 'str',value: 'str') -> 'bool':
    ...
    def GetDefault(self: 'NodeJSTranspiler',javascript_type: 'str') -> 'str':
        ...
        if javascript_type=="void":
            return "null"
        if self.BeginsWith("dict[str",javascript_type):
            return "new Map()"
        if self.BeginsWith("list[",javascript_type):
            return "[]"
        return "null"

    def MakeParametersString(self: 'NodeJSTranspiler',parameters: 'list[ParameterDeclaration]') -> 'str':
        result: 'str' = "("
    ...
    def StripDot(self: 'NodeJSTranspiler',input: 'str') -> 'str':
        index: 'int' = 0
        index = 0
        result: 'str' = ""
        result = ""
    ...
    def WriteLines(self: 'NodeJSTranspiler',destination: 'S84_CTCode_System_ctcode.OutputStream',lines: 'list[str]') -> 'None':
        lines_index: 'int' = 0
    ...
    def ProcessCTCodeFile(self: 'NodeJSTranspiler',c_t_code_file: 'S84_CTCode_dbnf_ctcode.CTCodeFile') -> 'None':
    ...
    def ProcessExdefs(self: 'NodeJSTranspiler',c_t_code_file: 'S84_CTCode_dbnf_ctcode.CTCodeFile') -> 'None':
    ...
    def ProcessUnmanagedTypes(self: 'NodeJSTranspiler',c_t_code_file: 'S84_CTCode_dbnf_ctcode.CTCodeFile') -> 'None':
    ...
    def ProcessDefinitions(self: 'NodeJSTranspiler',c_t_code_file: 'S84_CTCode_dbnf_ctcode.CTCodeFile') -> 'None':
    ...
    def GetParameters(self: 'NodeJSTranspiler',parameter_list_def: 'S84_CTCode_dbnf_ctcode.ParameterListDef') -> 'list[ParameterDeclaration]':
    ...
    def ProcessInterfaceDefinition(self: 'NodeJSTranspiler',interface_definition: 'S84_CTCode_dbnf_ctcode.InterfaceDef') -> 'None':
    ...
    def ProcessClassDefinition(self: 'NodeJSTranspiler',class_definition: 'S84_CTCode_dbnf_ctcode.ClassDef') -> 'None':
    ...
    def ProcessInstructionInternal(self: 'NodeJSTranspiler',indent: 'int',instruction: 'S84_CTCode_dbnf_ctcode.Instruction') -> 'None':
    ...
    def ProcessCodeBlockInternal(self: 'NodeJSTranspiler',indent: 'int',code_block: 'S84_CTCode_dbnf_ctcode.CodeBlock') -> 'None':
    ...
    def ProcessConditionalInternal(self: 'NodeJSTranspiler',indent: 'int',conditional: 'S84_CTCode_dbnf_ctcode.Conditional') -> 'None':
    ...
    def ProcessLoopInternal(self: 'NodeJSTranspiler',indent: 'int',loop: 'S84_CTCode_dbnf_ctcode.Loop') -> 'None':
    ...
    def ProcessRtnInternal(self: 'NodeJSTranspiler',indent: 'int',rtn: 'S84_CTCode_dbnf_ctcode.Return') -> 'None':
        r_value: 'str' = self.GetRValueInternal(rtn.GetRValue())
        self.ProcessRtn(indent,r_value)

    def ProcessDeclarationInternal(self: 'NodeJSTranspiler',indent: 'int',declaration: 'S84_CTCode_dbnf_ctcode.Declaration') -> 'None':
    ...
    def ProcessAssignmentInternal(self: 'NodeJSTranspiler',indent: 'int',assignment: 'S84_CTCode_dbnf_ctcode.Assignment') -> 'None':
        self.ProcessAssignment(indent,self.GetVariableChain(assignment.GetLValue()),self.GetRValueInternal(assignment.GetRValue()))

    def ProcessCallInternal(self: 'NodeJSTranspiler',indent: 'int',call: 'S84_CTCode_dbnf_ctcode.Call') -> 'None':
        self.ProcessCall(indent,self.ConvertCallInternal(call))

    def ConvertCallInternal(self: 'NodeJSTranspiler',call: 'S84_CTCode_dbnf_ctcode.Call') -> 'str':
        name_chain: 'list[str]' = []
        parameters: 'list[str]' = []
        if call.GetVariable():
    ...
    def GetSingletonType(self: 'NodeJSTranspiler',singleton_type: 'S84_CTCode_dbnf_ctcode.SingletonType') -> 'str':
    ...
    def GetRValueSingleBasisInternal(self: 'NodeJSTranspiler',r_value_single: 'S84_CTCode_dbnf_ctcode.RValueSingle') -> 'str':
    ...
    def GetRValueSingleInternal(self: 'NodeJSTranspiler',r_value_single: 'S84_CTCode_dbnf_ctcode.RValueSingle') -> 'str':
    ...
    def GetType(self: 'NodeJSTranspiler',type: 'S84_CTCode_dbnf_ctcode.ValueType') -> 'str':
    ...
    def Indentation(self: 'NodeJSTranspiler',indent: 'int') -> 'str':
        result: 'str' = ""
        result = ""
        while indent>0:
            indent = indent-1
    ...
    def SnakeCaseToCamelCase(self: 'NodeJSTranspiler',snake_case: 'str') -> 'str':
    ...
    def CamelCaseToSnakeCase(self: 'NodeJSTranspiler',camel_case: 'str') -> 'str':
        delimiter: 'str' = "_"
        snake_case: 'str' = ""
        index: 'int' = 0
    ...
    def IsUpper(self: 'NodeJSTranspiler',character: 'str') -> 'bool':
        result: 'bool' = False
        result = False
    ...
    def IsDigit(self: 'NodeJSTranspiler',character: 'str') -> 'bool':
        result: 'bool' = False
        result = False
    ...
    def ToLower(self: 'NodeJSTranspiler',input: 'str') -> 'str':
        index: 'int' = 0
        result: 'str' = ""
        while index<Length(input):
    ...
    def CharacterToLower(self: 'NodeJSTranspiler',input: 'str') -> 'str':
        if input=="A":
            return "a"
        if input=="B":
            return "b"
    ...
    def ToUpper(self: 'NodeJSTranspiler',input: 'str') -> 'str':
        index: 'int' = 0
        result: 'str' = ""
        while index<Length(input):
            character: 'str' = At(input,index)
    ...
    def CharacterToUpper(self: 'NodeJSTranspiler',input: 'str') -> 'str':
        if input=="a":
            return "A"
        if input=="b":
            return "B"

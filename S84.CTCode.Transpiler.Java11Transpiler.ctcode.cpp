...
void Java11Transpiler::WriteCommonFunctions(OmniPointer<s84::ctcode::system::ctcode::OutputStream> destination_file)
{
    ...
    destination_file->WriteLine(Concat(this->string_helper->Indentation(1),std::string("private static <T extends Object> boolean AsBoolean(T value) { return value != null; }")));

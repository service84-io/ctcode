#ifndef S84_CTCODE_TRANSPILER_RUBYTRANSPILER_CTCODE_H
...
class RubyTranspiler : public s84::ctcode::transpiler::standardstructure::ctcode::TargetSpecificFunctions {
public:
    RubyTranspiler();
    inline ~RubyTranspiler() {}

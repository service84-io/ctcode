...
class LogToConsole(S84_CTCode_Transpiler_ctcode.Transpiler):
    ...
    def PopulateOperatorPrecedent(self: 'LogToConsole') -> 'None':
    ...
    def OverPrecedent(self: 'LogToConsole',op: 'str',precedent: 'int') -> 'bool':
    ...
    def BinaryOperatorPrecedentMerge(self: 'LogToConsole',values: 'list[str]',operators: 'list[str]',index: 'IntegerReference',precedent: 'int') -> 'str':
        if precedent==-1:

...
public class ContentDefinitionParser {
    ...
    public boolean ParseSingleSave(LengthString index, ContentDefinitionResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ContentDefinitionResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ContentDefinitionListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ContentDefinition> results = new java.util.ArrayList<>();
        int count = 0;

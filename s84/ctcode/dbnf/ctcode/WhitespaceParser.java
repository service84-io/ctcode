...
public class WhitespaceParser {
    ...
    public boolean ParseSingleSave(LengthString index, WhitespaceResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, WhitespaceResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, WhitespaceListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Whitespace> results = new java.util.ArrayList<>();
        int count = 0;

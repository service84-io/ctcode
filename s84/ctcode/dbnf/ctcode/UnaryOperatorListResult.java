...
public class UnaryOperatorListResult {
    ...
    public void SetValue(java.util.ArrayList<UnaryOperator> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<UnaryOperator> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<UnaryOperator> value;

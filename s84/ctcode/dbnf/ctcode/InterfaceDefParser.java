...
public class InterfaceDefParser {
    ...
    public boolean ParseSingleSave(LengthString index, InterfaceDefResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, InterfaceDefResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, InterfaceDefListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<InterfaceDef> results = new java.util.ArrayList<>();
        int count = 0;

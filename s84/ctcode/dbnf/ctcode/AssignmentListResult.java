...
public class AssignmentListResult {
    ...
    public void SetValue(java.util.ArrayList<Assignment> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<Assignment> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<Assignment> value;

...
public class DimensionalTypeListResult {
    ...
    public void SetValue(java.util.ArrayList<DimensionalType> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<DimensionalType> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<DimensionalType> value;

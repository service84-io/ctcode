...
public class CodeBlockParser {
    ...
    public boolean ParseSingleSave(LengthString index, CodeBlockResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, CodeBlockResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, CodeBlockListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<CodeBlock> results = new java.util.ArrayList<>();
        int count = 0;

...
public class InstructionParser {
    ...
    public boolean ParseSingleSave(LengthString index, InstructionResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, InstructionResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, InstructionListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Instruction> results = new java.util.ArrayList<>();
        int count = 0;

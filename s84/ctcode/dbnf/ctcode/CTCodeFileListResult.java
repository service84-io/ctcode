...
public class CTCodeFileListResult {
    ...
    public void SetValue(java.util.ArrayList<CTCodeFile> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<CTCodeFile> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<CTCodeFile> value;

...
public class InterfaceDef {
    ...
    public void SetDeclarations(java.util.ArrayList<ContentDeclaration> input_value)
    {
        this.declarations_field = input_value;
    }

    public java.util.ArrayList<ContentDeclaration> GetDeclarations()
    {
    ...
    private java.util.ArrayList<ContentDeclaration> declarations_field;

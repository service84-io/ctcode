...
public class UnmanagedTypeParser {
    ...
    public boolean ParseSingleSave(LengthString index, UnmanagedTypeResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, UnmanagedTypeResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, UnmanagedTypeListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<UnmanagedType> results = new java.util.ArrayList<>();
        int count = 0;

...
public class DeclarationAssignListResult {
    ...
    public void SetValue(java.util.ArrayList<DeclarationAssign> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<DeclarationAssign> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<DeclarationAssign> value;

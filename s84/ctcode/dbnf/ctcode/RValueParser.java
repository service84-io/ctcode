...
public class RValueParser {
    ...
    public boolean ParseSingleSave(LengthString index, RValueResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, RValueResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, RValueListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<RValue> results = new java.util.ArrayList<>();
        int count = 0;

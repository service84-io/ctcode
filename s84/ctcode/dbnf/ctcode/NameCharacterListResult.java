...
public class NameCharacterListResult {
    ...
    public void SetValue(java.util.ArrayList<NameCharacter> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<NameCharacter> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<NameCharacter> value;

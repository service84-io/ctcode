...
public class DimensionalNoteListResult {
    ...
    public void SetValue(java.util.ArrayList<DimensionalNote> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<DimensionalNote> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<DimensionalNote> value;

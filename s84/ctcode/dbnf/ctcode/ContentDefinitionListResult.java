...
public class ContentDefinitionListResult {
    ...
    public void SetValue(java.util.ArrayList<ContentDefinition> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<ContentDefinition> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<ContentDefinition> value;

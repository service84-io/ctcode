...
public class MapTypeParser {
    ...
    public boolean ParseSingleSave(LengthString index, MapTypeResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, MapTypeResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, MapTypeListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<MapType> results = new java.util.ArrayList<>();
        int count = 0;

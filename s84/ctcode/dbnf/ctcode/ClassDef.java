...
public class ClassDef {
    ...
    public void SetDefinitions(java.util.ArrayList<ContentDefinition> input_value)
    {
        this.definitions_field = input_value;
    }

    public java.util.ArrayList<ContentDefinition> GetDefinitions()
    {
    ...
    private java.util.ArrayList<ContentDefinition> definitions_field;

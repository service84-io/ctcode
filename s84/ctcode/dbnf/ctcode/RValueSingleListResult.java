...
public class RValueSingleListResult {
    ...
    public void SetValue(java.util.ArrayList<RValueSingle> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<RValueSingle> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<RValueSingle> value;

...
public class DefinedTypeParser {
    ...
    public boolean ParseSingleSave(LengthString index, DefinedTypeResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, DefinedTypeResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, DefinedTypeListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<DefinedType> results = new java.util.ArrayList<>();
        int count = 0;

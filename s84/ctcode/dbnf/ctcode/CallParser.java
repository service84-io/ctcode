...
public class CallParser {
    ...
    public boolean ParseSingleSave(LengthString index, CallResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, CallResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, CallListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Call> results = new java.util.ArrayList<>();
        int count = 0;

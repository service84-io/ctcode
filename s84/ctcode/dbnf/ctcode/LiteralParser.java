...
public class LiteralParser {
    ...
    public boolean ParseSingleSave(LengthString index, LiteralResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, LiteralResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, LiteralListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Literal> results = new java.util.ArrayList<>();
        int count = 0;

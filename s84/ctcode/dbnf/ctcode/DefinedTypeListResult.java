...
public class DefinedTypeListResult {
    ...
    public void SetValue(java.util.ArrayList<DefinedType> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<DefinedType> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<DefinedType> value;

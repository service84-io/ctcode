...
public class SingletonTypeListResult {
    ...
    public void SetValue(java.util.ArrayList<SingletonType> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<SingletonType> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<SingletonType> value;

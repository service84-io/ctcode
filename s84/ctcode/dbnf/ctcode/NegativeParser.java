...
public class NegativeParser {
    ...
    public boolean ParseSingleSave(LengthString index, NegativeResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, NegativeResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, NegativeListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Negative> results = new java.util.ArrayList<>();
        int count = 0;

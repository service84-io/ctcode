...
public class ExternalDefinitionParser {
    ...
    public boolean ParseSingleSave(LengthString index, ExternalDefinitionResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ExternalDefinitionResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ExternalDefinitionListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ExternalDefinition> results = new java.util.ArrayList<>();
        int count = 0;

...
public class ParameterListParser {
    ...
    public boolean ParseSingleSave(LengthString index, ParameterListResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ParameterListResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ParameterListListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ParameterList> results = new java.util.ArrayList<>();
        int count = 0;

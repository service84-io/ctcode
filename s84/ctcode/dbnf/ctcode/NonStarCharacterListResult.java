...
public class NonStarCharacterListResult {
    ...
    public void SetValue(java.util.ArrayList<NonStarCharacter> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<NonStarCharacter> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<NonStarCharacter> value;

...
public class ByteParser {
    ...
    public boolean ParseSingleSave(LengthString index, ByteResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ByteResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ByteListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Byte> results = new java.util.ArrayList<>();
        int count = 0;

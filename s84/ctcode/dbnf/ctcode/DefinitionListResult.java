...
public class DefinitionListResult {
    ...
    public void SetValue(java.util.ArrayList<Definition> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<Definition> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<Definition> value;

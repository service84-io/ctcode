...
public class DecimalParser {
    ...
    public boolean ParseSingleSave(LengthString index, DecimalResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, DecimalResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, DecimalListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Decimal> results = new java.util.ArrayList<>();
        int count = 0;

...
public class QualfiedNameListResult {
    ...
    public void SetValue(java.util.ArrayList<QualfiedName> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<QualfiedName> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<QualfiedName> value;

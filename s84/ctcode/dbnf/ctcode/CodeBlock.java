...
public class CodeBlock {
    public CodeBlock()
    {
        ...
        this.instructions_field = new java.util.ArrayList<>();
    }
    ...
    public void SetInstructions(java.util.ArrayList<Instruction> input_value)
    {
    ...
    private java.util.ArrayList<Instruction> instructions_field;

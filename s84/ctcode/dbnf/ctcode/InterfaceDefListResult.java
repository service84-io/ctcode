...
public class InterfaceDefListResult {
    ...
    public void SetValue(java.util.ArrayList<InterfaceDef> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<InterfaceDef> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<InterfaceDef> value;

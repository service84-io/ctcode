...
public class NonStarCharacterParser {
    ...
    public boolean ParseSingleSave(LengthString index, NonStarCharacterResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, NonStarCharacterResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, NonStarCharacterListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<NonStarCharacter> results = new java.util.ArrayList<>();
        int count = 0;

...
public class ImplementationSpecListResult {
    ...
    public void SetValue(java.util.ArrayList<ImplementationSpec> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<ImplementationSpec> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<ImplementationSpec> value;

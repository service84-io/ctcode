...
public class CTCodeFile {
    public CTCodeFile()
    {
        ...
        this.declarations_field = new java.util.ArrayList<>();
        this.definitions_field = new java.util.ArrayList<>();
        this.unmanaged_types_field = new java.util.ArrayList<>();
    }
    ...
    public void SetDeclarations(java.util.ArrayList<ExternalDefinition> input_value)
    {
        this.declarations_field = input_value;
    }

    public java.util.ArrayList<ExternalDefinition> GetDeclarations()
    {
        return this.declarations_field;
    }

    public void SetDefinitions(java.util.ArrayList<Definition> input_value)
    {
        this.definitions_field = input_value;
    }

    public java.util.ArrayList<Definition> GetDefinitions()
    {
        return this.definitions_field;
    }

    public void SetUnmanagedTypes(java.util.ArrayList<UnmanagedType> input_value)
    {
        this.unmanaged_types_field = input_value;
    }

    public java.util.ArrayList<UnmanagedType> GetUnmanagedTypes()
    {
        return this.unmanaged_types_field;
    }

    private LengthString length_string;
    private java.util.ArrayList<ExternalDefinition> declarations_field;
    private java.util.ArrayList<Definition> definitions_field;
    private java.util.ArrayList<UnmanagedType> unmanaged_types_field;

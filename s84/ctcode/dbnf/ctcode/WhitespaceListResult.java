...
public class WhitespaceListResult {
    ...
    public void SetValue(java.util.ArrayList<Whitespace> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<Whitespace> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<Whitespace> value;

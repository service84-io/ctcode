...
public class NameCharacterParser {
    ...
    public boolean ParseSingleSave(LengthString index, NameCharacterResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, NameCharacterResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, NameCharacterListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<NameCharacter> results = new java.util.ArrayList<>();
        int count = 0;

...
public class PrimativeTypeParser {
    ...
    public boolean ParseSingleSave(LengthString index, PrimativeTypeResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, PrimativeTypeResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, PrimativeTypeListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<PrimativeType> results = new java.util.ArrayList<>();
        int count = 0;

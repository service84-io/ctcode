...
public class LiteralCharacterListResult {
    ...
    public void SetValue(java.util.ArrayList<LiteralCharacter> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<LiteralCharacter> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<LiteralCharacter> value;

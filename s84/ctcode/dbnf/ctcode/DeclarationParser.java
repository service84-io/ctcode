...
public class DeclarationParser {
    ...
    public boolean ParseSingleSave(LengthString index, DeclarationResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, DeclarationResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, DeclarationListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Declaration> results = new java.util.ArrayList<>();
        int count = 0;

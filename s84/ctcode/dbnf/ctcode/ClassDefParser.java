...
public class ClassDefParser {
    ...
    public boolean ParseSingleSave(LengthString index, ClassDefResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ClassDefResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ClassDefListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ClassDef> results = new java.util.ArrayList<>();
        int count = 0;

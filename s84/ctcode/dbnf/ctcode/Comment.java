...
public class Comment {
    public Comment()
    {
        ...
        this.content_field = new java.util.ArrayList<>();
    }
    ...
    public void SetContent(java.util.ArrayList<CommentContent> input_value)
    {
        this.content_field = input_value;
    }

    public java.util.ArrayList<CommentContent> GetContent()
    {
        return this.content_field;
    }

    private LengthString length_string;
    private java.util.ArrayList<CommentContent> content_field;

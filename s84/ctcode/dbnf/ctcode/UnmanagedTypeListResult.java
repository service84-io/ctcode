...
public class UnmanagedTypeListResult {
    ...
    public void SetValue(java.util.ArrayList<UnmanagedType> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<UnmanagedType> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<UnmanagedType> value;

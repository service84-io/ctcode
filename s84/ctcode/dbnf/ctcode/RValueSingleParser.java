...
public class RValueSingleParser {
    ...
    public boolean ParseSingleSave(LengthString index, RValueSingleResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, RValueSingleResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, RValueSingleListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<RValueSingle> results = new java.util.ArrayList<>();
        int count = 0;

...
public class CommentContentParser {
    ...
    public boolean ParseSingleSave(LengthString index, CommentContentResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, CommentContentResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, CommentContentListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<CommentContent> results = new java.util.ArrayList<>();
        int count = 0;

...
public class UnaryOperatorParser {
    ...
    public boolean ParseSingleSave(LengthString index, UnaryOperatorResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, UnaryOperatorResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, UnaryOperatorListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<UnaryOperator> results = new java.util.ArrayList<>();
        int count = 0;

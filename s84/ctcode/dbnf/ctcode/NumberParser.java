...
public class NumberParser {
    ...
    public boolean ParseSingleSave(LengthString index, NumberResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, NumberResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, NumberListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Number> results = new java.util.ArrayList<>();
        int count = 0;

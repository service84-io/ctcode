...
public class DimensionalNoteParser {
    ...
    public boolean ParseSingleSave(LengthString index, DimensionalNoteResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, DimensionalNoteResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, DimensionalNoteListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<DimensionalNote> results = new java.util.ArrayList<>();
        int count = 0;

...
public class CTCodeFileParser {
    ...
    public boolean ParseSingleSave(LengthString index, CTCodeFileResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, CTCodeFileResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, CTCodeFileListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<CTCodeFile> results = new java.util.ArrayList<>();
        int count = 0;

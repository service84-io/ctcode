...
public class ConditionalParser {
    ...
    public boolean ParseSingleSave(LengthString index, ConditionalResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ConditionalResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ConditionalListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Conditional> results = new java.util.ArrayList<>();
        int count = 0;

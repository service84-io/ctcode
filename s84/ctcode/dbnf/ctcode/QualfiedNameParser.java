...
public class QualfiedNameParser {
    ...
    public boolean ParseSingleSave(LengthString index, QualfiedNameResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, QualfiedNameResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, QualfiedNameListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<QualfiedName> results = new java.util.ArrayList<>();
        int count = 0;

...
public class ConditionalListResult {
    ...
    public void SetValue(java.util.ArrayList<Conditional> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<Conditional> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<Conditional> value;

...
public class CharacterRangeListResult {
    ...
    public void SetValue(java.util.ArrayList<CharacterRange> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<CharacterRange> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<CharacterRange> value;

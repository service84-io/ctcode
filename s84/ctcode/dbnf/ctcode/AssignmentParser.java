...
public class AssignmentParser {
    ...
    public boolean ParseSingleSave(LengthString index, AssignmentResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, AssignmentResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, AssignmentListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Assignment> results = new java.util.ArrayList<>();
        int count = 0;

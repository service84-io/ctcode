...
public class ImplementationSpecParser {
    ...
    public boolean ParseSingleSave(LengthString index, ImplementationSpecResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ImplementationSpecResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ImplementationSpecListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ImplementationSpec> results = new java.util.ArrayList<>();
        int count = 0;

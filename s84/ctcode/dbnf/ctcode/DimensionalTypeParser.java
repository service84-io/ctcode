...
public class DimensionalTypeParser {
    ...
    public boolean ParseSingleSave(LengthString index, DimensionalTypeResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, DimensionalTypeResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, DimensionalTypeListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<DimensionalType> results = new java.util.ArrayList<>();
        int count = 0;

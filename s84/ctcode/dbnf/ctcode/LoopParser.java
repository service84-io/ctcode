...
public class LoopParser {
    ...
    public boolean ParseSingleSave(LengthString index, LoopResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, LoopResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, LoopListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Loop> results = new java.util.ArrayList<>();
        int count = 0;

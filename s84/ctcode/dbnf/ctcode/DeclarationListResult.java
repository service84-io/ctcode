...
public class DeclarationListResult {
    ...
    public void SetValue(java.util.ArrayList<Declaration> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<Declaration> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<Declaration> value;

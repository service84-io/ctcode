...
public class NonSlashCharacterParser {
    ...
    public boolean ParseSingleSave(LengthString index, NonSlashCharacterResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, NonSlashCharacterResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, NonSlashCharacterListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<NonSlashCharacter> results = new java.util.ArrayList<>();
        int count = 0;

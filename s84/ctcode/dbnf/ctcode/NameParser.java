...
public class NameParser {
    ...
    public boolean ParseSingleSave(LengthString index, NameResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, NameResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, NameListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Name> results = new java.util.ArrayList<>();
        int count = 0;

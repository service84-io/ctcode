...
public class SingletonTypeParser {
    ...
    public boolean ParseSingleSave(LengthString index, SingletonTypeResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, SingletonTypeResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, SingletonTypeListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<SingletonType> results = new java.util.ArrayList<>();
        int count = 0;

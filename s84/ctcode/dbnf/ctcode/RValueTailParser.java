...
public class RValueTailParser {
    ...
    public boolean ParseSingleSave(LengthString index, RValueTailResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, RValueTailResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, RValueTailListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<RValueTail> results = new java.util.ArrayList<>();
        int count = 0;

...
public class BooleanParser {
    ...
    public boolean ParseSingleSave(LengthString index, BooleanResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, BooleanResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, BooleanListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();

...
public class PrimativeTypeListResult {
    ...
    public void SetValue(java.util.ArrayList<PrimativeType> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<PrimativeType> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<PrimativeType> value;

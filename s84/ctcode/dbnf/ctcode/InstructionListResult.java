...
public class InstructionListResult {
    ...
    public void SetValue(java.util.ArrayList<Instruction> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<Instruction> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<Instruction> value;

...
public class AllocateParser {
    ...
    public boolean ParseSingleSave(LengthString index, AllocateResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, AllocateResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, AllocateListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Allocate> results = new java.util.ArrayList<>();
        int count = 0;

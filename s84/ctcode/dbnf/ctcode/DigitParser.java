...
public class DigitParser {
    ...
    public boolean ParseSingleSave(LengthString index, DigitResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, DigitResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, DigitListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Digit> results = new java.util.ArrayList<>();
        int count = 0;

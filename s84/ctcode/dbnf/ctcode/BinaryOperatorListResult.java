...
public class BinaryOperatorListResult {
    ...
    public void SetValue(java.util.ArrayList<BinaryOperator> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<BinaryOperator> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<BinaryOperator> value;

...
public class DimensionalType {
    public DimensionalType()
    {
        ...
        this.dimensional_note_field = new java.util.ArrayList<>();
    ...
    public java.util.ArrayList<DimensionalNote> GetDimensionalNote()
    {
    ...
    private java.util.ArrayList<DimensionalNote> dimensional_note_field;

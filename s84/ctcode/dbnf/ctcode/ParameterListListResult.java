...
public class ParameterListListResult {
    ...
    public void SetValue(java.util.ArrayList<ParameterList> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<ParameterList> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<ParameterList> value;

...
public class CommentContentListResult {
    ...
    public void SetValue(java.util.ArrayList<CommentContent> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<CommentContent> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<CommentContent> value;

...
public class ReturnParser {
    ...
    public boolean ParseSingleSave(LengthString index, ReturnResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ReturnResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ReturnListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();

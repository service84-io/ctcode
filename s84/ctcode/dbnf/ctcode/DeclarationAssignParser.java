...
public class DeclarationAssignParser {
    ...
    public boolean ParseSingleSave(LengthString index, DeclarationAssignResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, DeclarationAssignResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, DeclarationAssignListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<DeclarationAssign> results = new java.util.ArrayList<>();
        int count = 0;

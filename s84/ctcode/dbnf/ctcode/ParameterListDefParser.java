...
public class ParameterListDefParser {
    ...
    public boolean ParseSingleSave(LengthString index, ParameterListDefResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ParameterListDefResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ParameterListDefListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ParameterListDef> results = new java.util.ArrayList<>();
        int count = 0;

...
public class ParameterListDefListResult {
    ...
    public void SetValue(java.util.ArrayList<ParameterListDef> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<ParameterListDef> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<ParameterListDef> value;

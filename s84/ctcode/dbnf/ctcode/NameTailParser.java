...
public class NameTailParser {
    ...
    public boolean ParseSingleSave(LengthString index, NameTailResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, NameTailResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, NameTailListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<NameTail> results = new java.util.ArrayList<>();
        int count = 0;

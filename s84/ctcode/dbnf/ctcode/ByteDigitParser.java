...
public class ByteDigitParser {
    ...
    public boolean ParseSingleSave(LengthString index, ByteDigitResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ByteDigitResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ByteDigitListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ByteDigit> results = new java.util.ArrayList<>();
        int count = 0;

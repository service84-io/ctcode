...
public class RValueTailListResult {
    ...
    public void SetValue(java.util.ArrayList<RValueTail> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<RValueTail> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<RValueTail> value;

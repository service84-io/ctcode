...
public class ContentDeclarationListResult {
    ...
    public void SetValue(java.util.ArrayList<ContentDeclaration> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<ContentDeclaration> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<ContentDeclaration> value;

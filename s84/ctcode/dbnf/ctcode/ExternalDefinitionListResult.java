...
public class ExternalDefinitionListResult {
    ...
    public void SetValue(java.util.ArrayList<ExternalDefinition> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<ExternalDefinition> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<ExternalDefinition> value;

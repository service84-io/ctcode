...
public class DefinitionParser {
    ...
    public boolean ParseSingleSave(LengthString index, DefinitionResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, DefinitionResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, DefinitionListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Definition> results = new java.util.ArrayList<>();
        int count = 0;

...
public class LiteralCharacterParser {
    ...
    public boolean ParseSingleSave(LengthString index, LiteralCharacterResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, LiteralCharacterResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, LiteralCharacterListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<LiteralCharacter> results = new java.util.ArrayList<>();
        int count = 0;

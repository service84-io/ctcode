...
public class MapNoteParser {
    ...
    public boolean ParseSingleSave(LengthString index, MapNoteResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, MapNoteResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, MapNoteListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<MapNote> results = new java.util.ArrayList<>();
        int count = 0;

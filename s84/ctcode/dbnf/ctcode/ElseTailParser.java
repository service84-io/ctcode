...
public class ElseTailParser {
    ...
    public boolean ParseSingleSave(LengthString index, ElseTailResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ElseTailResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ElseTailListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ElseTail> results = new java.util.ArrayList<>();
        int count = 0;

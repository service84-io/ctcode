...
public class CommentParser {
    ...
    public boolean ParseSingleSave(LengthString index, CommentResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, CommentResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, CommentListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<Comment> results = new java.util.ArrayList<>();
        int count = 0;

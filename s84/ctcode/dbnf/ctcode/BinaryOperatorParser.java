...
public class BinaryOperatorParser {
    ...
    public boolean ParseSingleSave(LengthString index, BinaryOperatorResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, BinaryOperatorResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, BinaryOperatorListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<BinaryOperator> results = new java.util.ArrayList<>();
        int count = 0;

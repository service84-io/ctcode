...
public class ContentDeclarationParser {
    ...
    public boolean ParseSingleSave(LengthString index, ContentDeclarationResult result)
    {
    ...
    public boolean ParseOptionalSave(LengthString index, ContentDeclarationResult result)
    {
    ...
    public boolean ParseManySave(LengthString index, ContentDeclarationListResult list_result, int minimum, int maximum)
    {
        int index_start = index.GetStart();
        int index_length = index.GetLength();
        java.util.ArrayList<ContentDeclaration> results = new java.util.ArrayList<>();
        int count = 0;

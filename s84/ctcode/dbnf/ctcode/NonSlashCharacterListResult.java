...
public class NonSlashCharacterListResult {
    ...
    public void SetValue(java.util.ArrayList<NonSlashCharacter> new_value)
    {
        this.value = new_value;
    }

    public java.util.ArrayList<NonSlashCharacter> GetValue()
    {
        return this.value;
    }
    ...
    private java.util.ArrayList<NonSlashCharacter> value;

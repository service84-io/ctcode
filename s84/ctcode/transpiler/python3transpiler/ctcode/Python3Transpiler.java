...
public class Python3Transpiler implements s84.ctcode.transpiler.ctcode.Transpiler {
    ...
    public java.lang.String GetDefault(java.lang.String python_type)
    {
        ...
        if (AsBoolean(this.BeginsWith("dict[str", python_type)))
        {
            return "{}";
        }
        if (AsBoolean(this.BeginsWith("list[", python_type)))
        {
            return "[]";
        }
        return "None";
    ...
    public java.lang.String MakeParametersString(java.lang.String self_type, java.util.ArrayList<ParameterDeclaration> parameters)
    {

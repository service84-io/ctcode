...
public class CPPTranspiler implements s84.ctcode.transpiler.ctcode.Transpiler {
    ...
    {
        java.lang.String guard_name = this.ToUpper(this.StripDot(Concat(this.base_name, "_H")));
    ...
    public java.lang.String GetDefault(java.lang.String cpp_type)
    {
        ...
        if (AsBoolean(this.BeginsWith("std::unordered_map<std::string, ", cpp_type)))
        {
            return "";
        }
        if (AsBoolean(this.BeginsWith("std::vector<", cpp_type)))
        {
            return "";
        }
        return "NULL";

...
public class StringHelper {
    ...
    {
        return (AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean((AsBoolean(false) || AsBoolean(this.BeginsWith("ReservedPrefix", name)))) || AsBoolean(this.BeginsWith("reserved_prefix_", name)))) || AsBoolean(Equals(name,"GetType")))) || AsBoolean(Equals(name,"Object")))) || AsBoolean(Equals(name,"Return")))) || AsBoolean(Equals(name,"String")))) || AsBoolean(Equals(name,"boolean")))) || AsBoolean(Equals(name,"char")))) || AsBoolean(Equals(name,"decimal")))) || AsBoolean(Equals(name,"end")))) || AsBoolean(Equals(name,"float")))) || AsBoolean(Equals(name,"object")))) || AsBoolean(Equals(name,"string")))) || AsBoolean(false));
    }
    ...
    public java.lang.String DotToFwdSlash(java.lang.String input)
    {
        java.lang.String result = "";
        int input_index = 0;
        while (AsBoolean((input_index<Length(input))))

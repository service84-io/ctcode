...
public class NodeJSTranspiler implements s84.ctcode.transpiler.ctcode.Transpiler {
    ...
    {
        Append(this.imports, Concat(Concat(Concat(Concat("import * as ", this.StripDot(exdef)), " from \"./"), this.StripDot(exdef)), ".js\""));
    }
    ...
    {
        Append(this.interface_definitions, Concat(Concat(Concat(this.Indentation(1), function_name), this.MakeParametersString(parameters)), " {}"));
    }
    ...
    public void BeginProcessingClass(java.lang.String class_name, java.lang.String implementing)
    {
        ...
        ClearList(this.class_init);
        ClearList(this.class_functions);
        Append(this.class_init, Concat(this.Indentation(1), "constructor() {"));
    }
    ...
    public void ProcessDeclaration(int indent, java.lang.String type, java.lang.String l_value, java.lang.String r_value)
    {
        ...
        Append(this.class_functions, Concat(Concat(Concat(Concat(this.Indentation(indent), "var "), l_value), " = "), r_value));
    }
    ...
    {
        Append(this.class_init, Concat(Concat(Concat(Concat(this.Indentation(2), "this."), member_name), " = "), this.GetDefault(member_type)));
    }
    ...
    {
        java.lang.String destination_file_name = Concat(this.StripDot(this.base_name), ".js");
    ...
    public java.lang.String GetDefault(java.lang.String javascript_type)
    {
        ...
        if (AsBoolean(this.BeginsWith("dict[str", javascript_type)))
        {
            return "new Map()";
        }
        if (AsBoolean(this.BeginsWith("list[", javascript_type)))
        {
            return "[]";
        }
        return "null";

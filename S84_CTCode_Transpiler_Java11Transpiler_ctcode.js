...
export class Java11Transpiler {
    ...
    IsReserved(name)
    {
        return false || this.BeginsWith("reserved_prefix_",name) || name=="boolean" || name=="float"
    }
    ...
    {
        var destination = this.system.OpenFileWriter(Concat(Concat(Concat(this.DotToSlash(this.ToLower(this.base_name)),"/"),this.current_interface),".java"))
    ...
    {
        var destination = this.system.OpenFileWriter(Concat(Concat(Concat(this.DotToSlash(this.ToLower(this.base_name)),"/"),this.current_class),".java"))
        destination.WriteLine(Concat(Concat("package ",this.ToLower(this.base_name)),";"))
        destination.WriteLine("")
        if (Size(this.imports)>0)
        {
    ...
    GetDefault(java_type)
    {
        ...
        if (this.BeginsWith("java.util.HashMap<java.lang.String",java_type))
        {
            return "new java.util.HashMap<>()"
        }
        if (this.BeginsWith("java.util.ArrayList<",java_type))
        {

...
void CPPTranspiler::PopulateOperatorPrecedent()
{
...
bool CPPTranspiler::OverPrecedent(std::string op, int precedent)
{
...
std::string CPPTranspiler::BinaryOperatorPrecedentMerge(std::vector<std::string> values, std::vector<std::string> operators, OmniPointer<IntegerReference> index, int precedent)
{
    if (precedent==-1)
    {

#ifndef S84_CTCODE_TRANSPILER_PHPTRANSPILER_CTCODE_H
#define S84_CTCODE_TRANSPILER_PHPTRANSPILER_CTCODE_H
...
class PHPTranspiler : public s84::ctcode::transpiler::standardstructure::ctcode::TargetSpecificFunctions {
public:
    PHPTranspiler();
    inline ~PHPTranspiler() {}

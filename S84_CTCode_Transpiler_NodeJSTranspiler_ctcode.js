...
export class NodeJSTranspiler {
    ...
    {
        var destination_file_name = Concat(this.StripDot(this.base_name),".js")
    ...
    GetDefault(javascript_type)
    {
        ...
        if (this.BeginsWith("dict[str",javascript_type))
        {
            return "new Map()"
        }
        if (this.BeginsWith("list[",javascript_type))
        {
            return "[]"
        }
        return "null"

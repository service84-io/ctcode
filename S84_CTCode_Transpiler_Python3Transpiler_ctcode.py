...
class Python3Transpiler(S84_CTCode_Transpiler_ctcode.Transpiler):
    ...
    def PopulateOperatorPrecedent(self: 'Python3Transpiler') -> 'None':
    ...
    def OverPrecedent(self: 'Python3Transpiler',op: 'str',precedent: 'int') -> 'bool':
    ...
    def BinaryOperatorPrecedentMerge(self: 'Python3Transpiler',values: 'list[str]',operators: 'list[str]',index: 'IntegerReference',precedent: 'int') -> 'str':
        if precedent==-1:
